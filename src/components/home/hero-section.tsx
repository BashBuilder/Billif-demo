        ...
        <div className="space-y-12 text-center">
          ...
          <div className="flex items-center gap-4 max-md:flex-col">
            <div className="mx-auto max-w-4xl space-y-6">
              <Fade className="inline-flex items-center rounded-full bg-white/80 px-4 py-2 text-sm font-medium text-secondary">
            ...
            <Fade duration={2} direction="left">
              <img
          ...
          <div className="relative mx-auto max-w-7xl">
            <Fade className="relative rounded-3xl border border-border/20 bg-gradient-to-br from-primary/5 to-secondary/5 p-8 shadow-2xl lg:p-12">
              ...
              <Fade className="absolute -right-4 -top-6 rounded-2xl bg-secondary px-4 py-3 text-secondary-foreground shadow-lg">
                <div className="text-sm font-bold">99.9%</div>
                <div className="text-xs opacity-90">Accuracy</div>
              </Fade>

              <Fade className="absolute -bottom-6 left-1/2 -translate-x-1/2 transform rounded-2xl bg-primary px-6 py-3 text-primary-foreground shadow-lg">
          ...
          {/* Key Benefits */}
          <Fade className="mx-auto grid max-w-4xl grid-cols-3 gap-8 pt-12">
          ...
          <Fade className="pt-12">
            ...
            <div className="overflow-hidden rounded-2xl bg-gradient-to-r from-primary/5 via-secondary/5 to-primary/5 p-8">
              <Fade className="flex flex-wrap items-center justify-center gap-8 lg:gap-12">
